...
describe('PUT requests', () =>{
    ...
    test('Rejects update-all request, status 405: Method not allowed.', 
        async() =>{
    ...
    test('Responds with created resource URI, status 201: Target does not exist, '+
    ...
    test('Responds with updated resource URI, status 200: Put request success.', 
        async() =>{
            const response = await request(app).put(
